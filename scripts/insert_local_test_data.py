...
def insert_test_data():
    ...
    try:
        # Connect to database
        print(f"Connecting to {LOCAL_DB_PARAMS['dbname']} at {LOCAL_DB_PARAMS['host']}:{LOCAL_DB_PARAMS['port']}...")
...
- **Net Margin**: 12.3% (+1.9pp YoY)"""
        ...
        print("\nCatalog records:")
        cursor.execute("SELECT id, document_source, document_type, document_name FROM apg_catalog")
