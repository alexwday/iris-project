...
def generate_test_summary_report(
    ...
    """
    logger.info(f"Generating test summary HTML report: {output_file}")
    ...
    try:
        ...
        logger.info(f"Test summary HTML report saved to: {output_file}")
        return output_file
    
    except Exception as e:
        logger.error(f"Error saving test summary HTML report: {str(e)}")
        raise
...
<body>
    ...
    <div class="report-meta">
        ...
        <p>Total Test Cases: {len(test_case_summaries)}</p>
    </div>
    """
    ...
    <div class="executive-summary">
        ...
        <div class="summary-container">
            {_markdown_to_html(test_suite_analysis['executive_summary'])}
        </div>
    """
...
"""
        ...
        <div class="summary-container">
            ...
            {_markdown_to_html(test_suite_analysis['overall_assessment'])}
        </div>
"""
...
"""
    ...
    <div class="sheet-container">
        <div class="sheet-header">
            <div>
                <h3>{sheet_name}</h3>
                <div class="info">Focus: {focus_area} • Test Cases: {len(summaries)}</div>
            </div>
...
def test_summary_json_to_html(
    ...
    try:
        ...
        if isinstance(data, dict) and 'executive_summary' in data and 'sheets_analysis' in data:
            ...
            for case_file in case_summary_files:
                try:
                    ...
                    logger.warning(f"Error loading test case summary {case_file}: {str(case_error)}")
        ...
        logger.error(f"Error converting test summary JSON to HTML: {str(e)}")
        raise