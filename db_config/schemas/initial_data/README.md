...
| `iris_database_registry.sql` | 19 database configs (SQL INSERT) | `psql -f iris_database_registry.sql` |
| `iris_database_registry.csv` | 19 database configs (CSV) | pgAdmin Import or `\copy` |
