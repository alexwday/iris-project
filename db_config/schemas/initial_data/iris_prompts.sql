...
-- Generated: 2026-01-19T10:33:07.915713
-- 
...
- Questions about IRIS itself: Describe IRIS''s capabilities, available databases (internal policies like CAPM, PAR, APG memos; external standards like IASB, EY guidance), and how it works
...
Response approach: Explain IRIS''s information sources - internal databases (CAPM policies, PAR guidance, APG memos, Wiki, cheatsheets) and external databases (IASB standards, EY guidance). This is information about IRIS itself that you can answer directly.
...
Response approach: List the available databases - internal sources (CAPM, PAR, APG memos, Wiki, etc.) and external sources (IASB standards, EY guidance). Describe what each contains at a high level.
</examples>', '<input>
