...
def check_certificate_expiry(cert_path: str) -> bool:
    ...
    if not CRYPTO_AVAILABLE:
        logger.warning("Cryptography library not available, skipping certificate expiry check")
        return True
...
def setup_ssl() -> str:
    ...
    logger.info(f"SSL environment configured successfully. Certificate path: {SSL_CERT_PATH}")
