...
AVAILABLE_DATABASES = {
    ...
    "external_ey": {
        ...
        "use_when": "Supplementary: External firm perspective on IFRS; disclosure checklists. **Strategy:** Consult to supplement internal knowledge, fill gaps, or get external interpretation after checking internal/IASB sources. Useful for disclosure examples. **Query:** Use standard numbers (IFRS 15, IAS 38), technical terms, specific paragraphs.",
    },
    "external_kpmg": {
        ...
        "query_type": "semantic search",
        "content_type": "external guidance",
        "use_when": "Supplementary: External firm perspective on IFRS. **Strategy:** Consult to supplement internal knowledge, fill gaps, or get external interpretation after checking internal/IASB sources. **Query:** Use standard numbers (IFRS 15, IAS 38), technical terms, specific paragraphs.",
    },
    "external_pwc": {
