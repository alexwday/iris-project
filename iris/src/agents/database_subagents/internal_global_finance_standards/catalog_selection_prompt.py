# internal_global_finance_standards/catalog_selection_prompt.py
"""
Prompt templates for selecting relevant Global Finance Standards documents from the catalog.

This module contains prompts used to guide the LLM in selecting
the most relevant documents from the Global Finance Standards catalog based on the user query.
"""


def get_catalog_selection_prompt(user_query: str, formatted_catalog: str) -> str:
    """
    Generate a prompt for selecting relevant documents from the Global Finance Standards catalog.

    Args:
        user_query (str): The original user query
        formatted_catalog (str): The formatted catalog of Global Finance Standards documents
