...
def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    """
    Generate a prompt for synthesizing content AND status from retrieved Global Finance Standards documents.

    Args:
        user_query (str): The original user query from the research statement
        formatted_documents (str): The formatted content of retrieved Global Finance Standards document sections
...
# Note: Internal Global Finance Standards doesn't seem to have an 'individual file synthesis' prompt.
