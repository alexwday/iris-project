...
def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    ...
    Args:
        ...
        formatted_documents (str): The formatted content of retrieved Internal Memos documents

    Returns:
        str: The formatted prompt for the LLM
    """
    prompt = f"""# TASK
You are an expert research assistant analyzing internal Memos documents to answer a user query.
...
## Instructions
1.  **Analyze Relevance:** Carefully read the user query and the provided Internal Memos document content. Determine how well the documents address the query.
