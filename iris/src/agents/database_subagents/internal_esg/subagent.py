...
def select_relevant_documents(
    ...
    token: Optional[str] = None,
    database_name: str = "internal_esg", # Default to esg
    ...
    try:
        ...
        try:
            ...
            if valid_ids:
                ...
                return valid_ids
            logger.error("Could not extract ESG document IDs from response using fallback.")
            return []
    except Exception as e:
...
def query_database_sync(
    ...
    try:
        ...
        catalog = fetch_esg_catalog() # Use esg function
