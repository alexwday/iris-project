...
"""
Internal Management Reporting Subagent (Sync Version)

This module handles queries to the Internal Management Reporting database synchronously,
...
def select_relevant_documents(
    ...
    token: Optional[str] = None,
    database_name: str = "internal_management_reporting",
) -> List[str]:
    """
    Use an LLM to select the most relevant Management Reporting documents synchronously.
    """
