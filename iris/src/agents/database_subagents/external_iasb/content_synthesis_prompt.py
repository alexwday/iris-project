...
def get_content_synthesis_prompt(query: str, formatted_cards: str) -> str:
    ...
    prompt_parts = [
        ...
        '   * **CRITICAL CITATION: Cite sources accurately *inline* within the report body, immediately following the information they support. Use the fields from the card(s) you used: `Chapter`, `Section Title`, `Section Hierarchy`, `Standard`, `Standard Codes`. Format citations like: `(Source: IASB Official Text, Chapter: [Chapter Name], Section: [Section Title/Hierarchy], Standard: [Standard], Code: [Standard Codes])`. Use the most specific location identifier (Section Title or Hierarchy). Include Standard/Code if relevant to the cited point. **Crucially, ensure the citation reflects the specific standard or interpretation (e.g., IAS 1, IFRS 16, IFRIC 12, SIC 29) mentioned in the card\'s \'Standard\' or \'Standard Codes\' field.**`',
