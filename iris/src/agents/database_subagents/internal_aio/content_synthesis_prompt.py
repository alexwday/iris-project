...
SUBAGENT_ROLE = "an expert research assistant specializing in analyzing internal AIO (Auditor Independence Office) policy documents, procedures, and FAQs"
...
def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    ...
    prompt_parts = [
        ...
        "<CONTEXT>",
        "You are analyzing sections from the internal AIO (Auditor Independence Office) database.",
