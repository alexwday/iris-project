...
def query_database_sync(
    ...
    """
    Synchronously query the External PwC database using vector search and refinement.
    ...
    Returns:
        DatabaseResponse: Query results. For PwC, only 'research' is supported.
    ...
    try:
        ...
        # 3. Initial Vector Search (Filter by specific PwC document ID)
