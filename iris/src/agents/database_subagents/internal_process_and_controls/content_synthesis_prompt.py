...
def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    """
    Generate a prompt for synthesizing content AND status from retrieved Process and Controls documents.

    Args:
        user_query (str): The original user query from the research statement
        formatted_documents (str): The formatted content of retrieved Process and Controls document sections
...
# Note: Internal Process and Controls doesn't seem to have an 'individual file synthesis' prompt.
