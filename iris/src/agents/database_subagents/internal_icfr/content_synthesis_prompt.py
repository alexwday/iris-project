...
"""
Prompt templates for synthesizing content from retrieved ICFR documents.

This module contains prompts used to guide the LLM in synthesizing
content from multiple ICFR documents to form a comprehensive response.
"""
...
def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    ...
    """
    prompt = f"""# TASK
You are helping to synthesize information from multiple internal ICFR (Internal Control over Financial Reporting) documents
