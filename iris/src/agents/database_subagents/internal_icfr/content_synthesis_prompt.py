...
SUBAGENT_ROLE = "an expert research assistant specializing in analyzing internal ICFR (Internal Control over Financial Reporting) documents"

# CO-STAR Framework Components
SUBAGENT_OBJECTIVE = """
To analyze provided ICFR document sections against a user query and generate an internal research report for the Summarizer agent.
...
def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    ...
    Args:
        ...
        formatted_documents (str): The formatted content of retrieved ICFR document sections
