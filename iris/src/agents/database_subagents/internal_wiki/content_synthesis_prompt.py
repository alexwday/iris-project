...
SUBAGENT_OBJECTIVE = """
To analyze provided Wiki document sections against a user query and generate an internal research report for the Summarizer agent.
...
def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    ...
    prompt_parts = [
        ...
        "</INPUT_DOCUMENTS>",
        "<INSTRUCTIONS>",
        "1. **Analyze Relevance:** Carefully read the user query and the provided Wiki document section content. Determine how well the content addresses the query.",
