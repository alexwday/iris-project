...
def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    ...
    """
    prompt = f"""# TASK
You are an expert research assistant analyzing internal wiki documents to answer a user query.
...
## Instructions
1.  **Analyze Relevance:** Carefully read the user query and the provided document content. Determine how well the documents address the query.
