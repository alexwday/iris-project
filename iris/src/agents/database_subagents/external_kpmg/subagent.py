...
DATABASE_NAME = "external_kpmg" # Changed to KPMG
TARGET_TABLE = "iris_textbook_database"  # Assuming same table for now, as requested
KPMG_DOCUMENT_ID = "kpmg_insights_into_ifrs_20th_edition" # Specific KPMG doc ID
