# internal_ext_reporting_and_disclosure/catalog_selection_prompt.py
"""
Prompt templates for selecting relevant External Reporting and Disclosure documents from the catalog.

This module contains prompts used to guide the LLM in selecting
the most relevant documents from the External Reporting and Disclosure catalog based on the user query.
"""


def get_catalog_selection_prompt(user_query: str, formatted_catalog: str) -> str:
    """
    Generate a prompt for selecting relevant documents from the External Reporting and Disclosure catalog.

    Args:
        user_query (str): The original user query
        formatted_catalog (str): The formatted catalog of External Reporting and Disclosure documents
