...
"""
Prompt templates for synthesizing content from retrieved PAR documents.

This module contains prompts used to guide the LLM in synthesizing
content from multiple PAR documents to form a comprehensive response.
"""


def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    """
    Generate a prompt for synthesizing content from retrieved PAR documents.
