...
def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    ...
    Args:
        ...
        formatted_documents (str): The formatted content of retrieved PAR documents

    Returns:
        str: The formatted prompt for the LLM
    """
    prompt = f"""# TASK
You are an expert research assistant analyzing internal PAR (Project Approval Request Guidance) documents to answer a user query.
...
## Instructions
1.  **Analyze Relevance:** Carefully read the user query and the provided PAR document content. Determine how well the documents address the query.
