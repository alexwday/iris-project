...
Functions:
    clarify_research_needs: Determines if essential context is needed or if research can proceed
...
def clarify_research_needs(conversation, token):
    ...
    try:
        ...
        try:
            ...
            raise ClarifierError(f"Invalid JSON in tool arguments: {tool_call.function.arguments}")
