...
class ChatRequest(BaseModel):
    ...
    db_names: Optional[List[str]] = Field(default=None, description="List of database names to query")
...
async def stream_chat_response(conversation: List[Dict[str, str]], db_names: Optional[List[str]] = None):
    """
    ...
    try:
        ...
        def run_sync_generator():
            ...
            try:
                for chunk in model_func(conversation_dict, debug_mode=False, db_names=db_names):
...
async def chat_endpoint(request: ChatRequest):
    ...
    try:
        ...
        if request.stream:
            ...
            result = await process_request_async(conversation, stream=False, db_names=request.db_names)
