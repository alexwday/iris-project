...
def _build_usage_details_from_response(
    ...
    Args:
        api_response (Any): The OpenAI API response object.
    ...
    Returns:
        UsageDetails: Usage details dict or None if no usage data.
    """
...
def _stream_response_with_usage(
    ...
    Yields:
        Iterator: Response chunks followed by a usage details dict.
    """
