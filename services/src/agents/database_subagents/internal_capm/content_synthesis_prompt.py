...
def get_content_synthesis_prompt(user_query: str, formatted_documents: str) -> str:
    ...
    prompt_parts = [
        ...
        "   * CRITICAL: Never use quotes, double quotes, or backslashes in research_content",
        "   * CRITICAL: Never include line breaks or newlines in research_content - use semicolons to separate ideas",
        ...
        "   * research_content: Plain text research extracted from that page (NO quotes, NO line breaks, NO backslashes)",
        "</INSTRUCTIONS>",
